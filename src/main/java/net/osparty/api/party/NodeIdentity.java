...
/**
 * This node's identity for party ownership + node-hint routing (PARTY_V2_MIGRATION.md §3.2/§4.1).
 *
 ...
 * forward a joiner to the owning pod. Injected from {@code app.party.node-id} / {@code POD_NAME} when
...
public class NodeIdentity {
	...
	@Autowired
	public NodeIdentity(@Value("${app.party.node-id:${POD_NAME:}}") String configured) {
